        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <ul className="mt-6 space-y-2 text-gray-700">
            <li className="flex items-start">
              <span className="text-green-500 text-lg mr-2">✔</span> Susce risus
              suscipit egestas leo
            </li>
            <li className="flex items-start">
              <span className="text-green-500 text-lg mr-2">✔</span> Etiam
              etbibendum dignissim posuere
            </li>
            <li className="flex items-start">
              <span className="text-green-500 text-lg mr-2">✔</span> Lorem ipsum
      ...
      <div className="container mx-auto px-6">
        ...
        <section className="relative bg-[#F9F8F3] py-16">
          ...
          <div className="relative max-w-[1200px] mx-auto text-center px-6">
            {/* Заголовки */}
            <p className="text-[#C4A65A] text-lg font-medium">
              Our Testimonials
            </p>
            <h2 className="text-4xl font-bold text-[#333] mt-2">
              What They Say
            </h2>
